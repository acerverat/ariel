#!/usr/bin/env bash
# run_remote.sh — for running a published release from GitHub.
...
REVISION="<VERSION>"                      # e.g. v1.0.0
REFERENCE_DIR="<PATH_TO_GRCh38_no_alt>"  # absolute path to GRCh38_no_alt/
TPM_PANEL="<PATH_TO_tpmPanel.tsv>"        # absolute path to tpmPanel.tsv
SAMPLE_SHEET="<PATH_TO_SAMPLE_SHEET>"     # absolute path to sample_sheet.tsv
BASE_DIR="<PATH_TO_RUNS_BASE>"            # parent directory where run folders will be created
